...
{
	AlertData * data;
	if (forBubble && ![[CommentaryBubble Instance] bubbleCommentaryPref] )
		data = [[RacePadDatabase Instance] rcMessages];
	else 
...
{
	if ( smallFont
	  && ( !forBubble || [[CommentaryBubble Instance] bubbleCommentaryPref] ) )
		return 18;
