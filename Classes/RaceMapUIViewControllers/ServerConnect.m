...
{
	[[RaceMapCoordinator Instance] connectionTimeout];
...
- (void) popDown
{
	...
	[self dismissViewControllerAnimated:YES completion:nil];
	[[RaceMapCoordinator Instance] setShowingConnecting:false];
...
-(void) retryPressed:(id)sender
{
	...
	[[RaceMapCoordinator Instance] SetServerAddress:[[BasePadPrefs Instance] getPref:@"preferredServerAddress"] ShowWindow:NO LightRestart:false];
}
