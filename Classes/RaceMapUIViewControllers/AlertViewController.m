...
- (bool) HandleSelectRow:(int)row DoubleClick:(bool)double_click LongPress:(bool)long_press
{
	...
	[[RaceMapCoordinator Instance] jumpToTime:time];
	...
	[[RaceMapCoordinator Instance] setPlaybackRate:1.0];
	[[RaceMapCoordinator Instance] prepareToPlay];
	[[RaceMapCoordinator Instance] startPlay];
