...
{	
	...
	[[RaceMapCoordinator Instance] setVideoViewController:self];
}
...
- (void)viewWillAppear:(BOOL)animated
{
	...
	[[RaceMapCoordinator Instance] RegisterViewController:self WithTypeMask:(RPC_VIDEO_VIEW_ | RPC_TRACK_MAP_VIEW_ | RPC_LAP_COUNT_VIEW_)];
...
{
	if([[RaceMapCoordinator Instance] diagnostics] && [[RaceMapCoordinator Instance] liveMode])
	{
