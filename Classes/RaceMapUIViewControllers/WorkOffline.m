...
{
	logo.image = [[RaceMapSponsor Instance] getSponsorLogo:BPS_LOGO_BIG_];
...
- (IBAction)onlinePressed:(id)sender
{
	...
	if(serverAddress && [serverAddress length] > 0)
		[[RaceMapCoordinator Instance] SetServerAddress:serverAddress ShowWindow:YES LightRestart:false];
