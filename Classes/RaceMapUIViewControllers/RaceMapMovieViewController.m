...
#import "RaceMapMovieViewController.h"
#import "RaceMapCoordinator.h"
#import "BasePadTimeController.h"
#import "RaceMapTitleBarController.h"

@implementation RaceMapMovieViewController
...
{
	NSString *name = [[RaceMapCoordinator Instance] getVideoArchiveName];
...
- (void)viewDidLoad
{
	...
	[[RaceMapCoordinator Instance] AddView:movieView WithType:RPC_VIDEO_VIEW_];
...
- (void)viewWillAppear:(BOOL)animated
{
	...
	// Grab the title bar
	[[RaceMapTitleBarController Instance] displayInViewController:self SupportCommentary:false];
		
	// Register the view
	[[RaceMapCoordinator Instance] RegisterViewController:self WithTypeMask:(RPC_VIDEO_VIEW_ | RPC_LAP_COUNT_VIEW_)];
	...
	// Set the play time
	float time_of_day = [[RaceMapCoordinator Instance] currentTime];
	[self movieGotoTime:time_of_day];

	[[RaceMapCoordinator Instance] SetViewDisplayed:movieView];
...
{
	[[RaceMapCoordinator Instance] SetViewHidden:movieView];
