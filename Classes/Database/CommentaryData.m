...
- (void) fillWithDefaultData:(int)car
{
	if(car == RPD_BLUE_CAR_)
	{
		...
		[self addItemWithType:ALERT_INFO_ Lap:35 TimeStamp:54753.3 Focus:@"MSC" Description:@"Michael exited the pits in 6th place"];
	...
	else
	{
		...
		[self addItemWithType:ALERT_INFO_ Lap:35 TimeStamp:54639.1 Focus:@"ROS" Description:@"Nico exited the pits in 9th place"];
		...
		[self addItemWithType:ALERT_INFO_ Lap:35 TimeStamp:54763.3 Focus:@"ROS" Description:@"Nico exited the pits in 9th place"];
