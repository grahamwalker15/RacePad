...
- (void) updateButtons
{
    ...
    // highlight in branding colour
    float r,g,b;
    [[BasePadSponsor Instance]primaryBrandingColor:&r:&g:&b];
    
    [button1 setTitleColor:[UIColor colorWithRed:r green:g blue:b alpha:1] forState:UIControlStateHighlighted];
    [button2 setTitleColor:[UIColor colorWithRed:r green:g blue:b alpha:1] forState:UIControlStateHighlighted];
    [button3 setTitleColor:[UIColor colorWithRed:r green:g blue:b alpha:1] forState:UIControlStateHighlighted];
    [button4 setTitleColor:[UIColor colorWithRed:r green:g blue:b alpha:1] forState:UIControlStateHighlighted];
    [button5 setTitleColor:[UIColor colorWithRed:r green:g blue:b alpha:1] forState:UIControlStateHighlighted];
    [button6 setTitleColor:[UIColor colorWithRed:r green:g blue:b alpha:1] forState:UIControlStateHighlighted];
    [button7 setTitleColor:[UIColor colorWithRed:r green:g blue:b alpha:1] forState:UIControlStateHighlighted];
}
